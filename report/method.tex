...
Let $s_i^k$ be the $k$-th tweet in user $\x_i$ timeline. Each tweet is scored by a function $TS(\cdot)$. We build upon \eqnref{eq:unc} and incorporate the tweet selection into the student's objective:
%
